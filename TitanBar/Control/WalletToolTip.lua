...
function RefreshWITTListBox()
	...
	for i = 1, #MenuItem do
		...
		elseif wttcur == L["MSP"] then ttw = _G.SPWhere; CtrIconCodeIs=WalletItem.Shards.Icon; CtrQteIs=GetCurrency( L[ "MSP" ] );
		elseif wttcur == L["MSM"] then ttw = _G.SMWhere; CtrIconCodeIs=WalletItem.Mark.Icon; CtrQteIs=GetCurrency( L[ "MSM" ] );
		elseif wttcur == L["MMC"] then ttw = _G.MCWhere; CtrIconCodeIs=WalletItem.MithrilCoins.Icon; CtrQteIs=GetCurrency( L[ "MMC" ] );
		...
		elseif wttcur == L["MMP"] then ttw = _G.MPWhere; CtrIconCodeIs=WalletItem.Medallions.Icon; CtrQteIs=GetCurrency( L[ "MMP" ] );
		elseif wttcur == L["MSL"] then ttw = _G.SLWhere; CtrIconCodeIs=WalletItem.Seals.Icon; CtrQteIs=GetCurrency( L[ "MSL" ] );
